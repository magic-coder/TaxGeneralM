 ...
 *  按钮样式，不用系统的是为了版本适配
 */
typedef NS_ENUM(NSInteger, YZAlertActionStyle) {
    YZAlertActionStyleDefault = UIAlertActionStyleDefault,
    YZAlertActionStyleCancel = UIAlertActionStyleCancel,
    YZAlertActionStyleDestructive = UIAlertActionStyleDestructive
};



@interface YZAlertView : NSObject
